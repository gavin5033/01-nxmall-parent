...
<div class="w">
    <div id="logo">
    	<a href="http://localhost" clstag="passport|keycount|login|01">
    		<img src="/images/EGO-logo.gif" alt="奈学" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						alert("登录成功！");
						var url;
						if (redirectUrl == "") { //合并购物车逻辑。注意跨域
							url = "http://localhost:8086/cart/merge";
						} else {
							url = redirectUrl;
						}
						location.href=url;
